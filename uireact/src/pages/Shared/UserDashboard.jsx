...
const UserDashboard = () => {
  return (
    <div className='container px-24 py-8 mx-auto bg-blue-00'>
      ...
      <div className='grid grid-cols-2 gap-8'>
        ...
        <div className='p-8 bg-white rounded-lg shadow-lg hover:shadow-xl'>
          <div className='flex items-center justify-center w-16 h-16 mx-auto mb-4 bg-blue-200 rounded-full'>
            <CalendarDays size={32} color='#1F2937' />
          </div>
        ...
        <div className='p-8 bg-white rounded-lg shadow-lg hover:shadow-xl'>
          <div className='flex items-center justify-center w-16 h-16 mx-auto mb-4 bg-blue-200 rounded-full'>
            <CalendarCheck size={32} color='#1F2937' />
          </div>
        ...
        <div className='p-8 bg-white rounded-lg shadow-lg hover:shadow-xl'>
          <div className='flex items-center justify-center w-16 h-16 mx-auto mb-4 bg-blue-200 rounded-full'>
            <TabletSmartphone size={32} color='#1F2937' />
          </div>
